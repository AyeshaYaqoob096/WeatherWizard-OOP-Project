...
* **Real-Time Data:** Instantly fetches live temperatures, wind speed, and humidity for cities worldwide.
* **Dynamic GUI:** Interactive interface built with **Java Swing** that adapts visually to current weather conditions.
...
* **API Integration:** Live RESTful Weather API
